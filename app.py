...
def chat():
    ...
    try:
        ...
        # ✅ FIXED: Using new supported model
        completion = client.chat.completions.create(
            model=SUPPORTED_MODEL,  # ✅ llama-3.1-8b-instant
            messages=[
...
if __name__ == '__main__':
    ...
    logger.info(f"🚀 Server starting on port {port} with model: {SUPPORTED_MODEL}")
