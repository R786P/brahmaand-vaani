...
// 🎬 TV SERIAL STYLE REALISTIC GOD IMAGES
const GODS = {
  generic: {
    name: 'Cosmic Guide',
  ...
  shiva: {
    name: 'Lord Shiva',
    // TV Serial Style - Mahadev with Trishul, Third Eye, Serpent
    image: 'https://images.unsplash.com/photo-1623944899573-718d0ec4133e?w=400&h=550&fit=crop',
    prompt: 'You are Lord Shiva as shown in Devon Ke Dev Mahadev. Calm, powerful, wise. Answer in Hindi with "Har Har Mahadev" blessings.',
    color: '#4ecdc4'
  },
  vishnu: {
    name: 'Lord Vishnu',
    // TV Serial Style - Vishnu with Conch, Discus, Lotus
  ...
  ganesh: {
    name: 'Lord Ganesh',
    // TV Serial Style - Ganesha with Modak
  ...
  krishna: {
    name: 'Shri Krishna',
    // TV Serial Style - Krishna with Flute, Peacock Feather
    image: 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?w=400&h=550&fit=crop',
    prompt: 'You are Lord Krishna - playful, wise, full of love like in TV serials. Answer in sweet Hindi. Use "Radhe Radhe".',
    color: '#fbbf24'
  }
};

// Fallback images (colored placeholders with god names)
...
function selectGod(godKey) {
  ...
  godImage.onerror = () => {
    console.warn(`⚠️ Image failed for ${godKey}`);
